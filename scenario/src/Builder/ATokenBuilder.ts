  ...
  const fetchers = [
    ...
    new Fetcher<{symbol: StringV, name: StringV, decimals: NumberV, admin: AddressV, comptroller: AddressV, interestRateModel: AddressV, initialExchangeRate: NumberV}, TokenData>(`
        ...
        * "ABNBScenario symbol:<String> name:<String> comptroller:<Address> interestRateModel:<Address> initialExchangeRate:<Number> decimals:<Number> admin: <Address>" - A AToken Scenario for local testing
          * E.g. "AToken Deploy ABNBScenario aBNB \"Atlantis Ether\" (Comptroller Address) (InterestRateModel Address) 1.0 8"
      `,
      "ABNBScenario",
      [
        new Arg("symbol", getStringV),
    ...
    new Fetcher<{symbol: StringV, name: StringV, decimals: NumberV, admin: AddressV, comptroller: AddressV, interestRateModel: AddressV, initialExchangeRate: NumberV}, TokenData>(`
        ...
        * "ABNB symbol:<String> name:<String> comptroller:<Address> interestRateModel:<Address> initialExchangeRate:<Number> decimals:<Number> admin: <Address>" - A AToken Scenario for local testing
          * E.g. "AToken Deploy ABNB aBNB \"Atlantis Ether\" (Comptroller Address) (InterestRateModel Address) 1.0 8"
      `,
      "ABNB",
      [
        new Arg("symbol", getStringV),
